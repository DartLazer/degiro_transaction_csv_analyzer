...
def fetch_yearly_stock_prices(ticker, unique_years):
    yearly_prices = {}
...
def calculate_multi_year_gain() -> None:
    ...
    for stock in unique_stocks:
        ...
        # Collect all years for which we have transactions and the current year
        ...
        unique_years = sorted(set(all_years + unique_years))
        ...
        total_gain_percent = ((final_worth / total_invested) - 1) * 100
